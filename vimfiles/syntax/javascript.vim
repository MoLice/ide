...
if !exists("javascript_ignore_javaScriptdoc")
  ...
  syntax match  javaScriptDocTags       contained "@\(param\|arguments\|requires\|exception\|throws\|type\|class\|property\|return\|extends\|see\|link\|member\|module\|method\|title\|namespace\|optional\|default\|base\|file\)\>" nextgroup=javaScriptDocParam,javaScriptDocSeeTag skipwhite
  syntax match  javaScriptDocTags       contained "@\(beta\|deprecated\|description\|fileoverview\|author\|create\|example\|log\|license\|version\|constructor\|private\|protected\|final\|ignore\|addon\|exec\)\>"
